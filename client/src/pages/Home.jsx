  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"
          style={{ backgroundColor: "var(--color-blob-1)" }} />
        <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000"
          style={{ backgroundColor: "var(--color-blob-2)" }} />
        <div className="absolute top-[20%] left-[20%] w-[400px] h-[400px] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000"
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center z-10">
        <div className="flex flex-col items-center gap-6">
          ...
          >
            ...
            Manage schedules, track performance, and empower your team—all in one place.
          </p>
