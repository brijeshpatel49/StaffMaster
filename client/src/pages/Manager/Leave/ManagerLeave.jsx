                ...
                {myPagination.totalPages > 1 && (
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "16px", paddingTop: "12px", borderTop: "1px solid var(--color-border-light)" }}>
                    ...
                    <div style={{ display: "flex", gap: "6px" }}>
                      <button className="pager-nav-btn" onClick={() => fetchMyLeaves(myPagination.page - 1)} disabled={myPagination.page <= 1} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: myPagination.page <= 1 ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: myPagination.page <= 1 ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: myPagination.page <= 1 ? 0.5 : 1 }}>
                        <ChevronLeft size={16} /> Prev
                      </button>
                      <button className="pager-nav-btn" onClick={() => fetchMyLeaves(myPagination.page + 1)} disabled={myPagination.page >= myPagination.totalPages} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: myPagination.page >= myPagination.totalPages ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: myPagination.page >= myPagination.totalPages ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: myPagination.page >= myPagination.totalPages ? 0.5 : 1 }}>
            ...
            <>
              ...
              {pendingPagination.totalPages > 1 && (
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "16px", paddingTop: "12px", borderTop: "1px solid var(--color-border-light)" }}>
                  ...
                  <div style={{ display: "flex", gap: "6px" }}>
                    <button className="pager-nav-btn" onClick={() => fetchPending(pendingPagination.page - 1)} disabled={pendingPagination.page <= 1} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: pendingPagination.page <= 1 ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: pendingPagination.page <= 1 ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: pendingPagination.page <= 1 ? 0.5 : 1 }}>
                      <ChevronLeft size={16} /> Prev
                    </button>
                    <button className="pager-nav-btn" onClick={() => fetchPending(pendingPagination.page + 1)} disabled={pendingPagination.page >= pendingPagination.totalPages} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: pendingPagination.page >= pendingPagination.totalPages ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: pendingPagination.page >= pendingPagination.totalPages ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: pendingPagination.page >= pendingPagination.totalPages ? 0.5 : 1 }}>
                      Next <ChevronRight size={16} />
                    </button>
                  </div>
                </div>
            ...
            <>
              ...
              {teamPagination.totalPages > 1 && (
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "16px", paddingTop: "12px", borderTop: "1px solid var(--color-border-light)" }}>
                  ...
                  <div style={{ display: "flex", gap: "6px" }}>
                    <button className="pager-nav-btn" onClick={() => fetchTeamHistory(teamPagination.page - 1)} disabled={teamPagination.page <= 1} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: teamPagination.page <= 1 ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: teamPagination.page <= 1 ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: teamPagination.page <= 1 ? 0.5 : 1 }}>
                      <ChevronLeft size={16} /> Prev
                    </button>
                    <button className="pager-nav-btn" onClick={() => fetchTeamHistory(teamPagination.page + 1)} disabled={teamPagination.page >= teamPagination.totalPages} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: teamPagination.page >= teamPagination.totalPages ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: teamPagination.page >= teamPagination.totalPages ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: teamPagination.page >= teamPagination.totalPages ? 0.5 : 1 }}>
                      Next <ChevronRight size={16} />
                    </button>
                  </div>
                </div>
