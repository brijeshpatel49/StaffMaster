          ...
          <>
            ...
            {pagination.totalPages > 1 && (
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "16px", paddingTop: "12px", borderTop: "1px solid var(--color-border-light)" }}>
                ...
                <div style={{ display: "flex", gap: "6px" }}>
                  <button className="pager-nav-btn" onClick={() => fetchLeaves(pagination.page - 1)} disabled={pagination.page <= 1} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: pagination.page <= 1 ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: pagination.page <= 1 ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: pagination.page <= 1 ? 0.5 : 1 }}>
                    <ChevronLeft size={16} /> Prev
                  </button>
                  <button className="pager-nav-btn" onClick={() => fetchLeaves(pagination.page + 1)} disabled={pagination.page >= pagination.totalPages} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid var(--color-border)", backgroundColor: "transparent", color: pagination.page >= pagination.totalPages ? "var(--color-text-muted)" : "var(--color-text-primary)", fontSize: "13px", fontWeight: 600, cursor: pagination.page >= pagination.totalPages ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "4px", opacity: pagination.page >= pagination.totalPages ? 0.5 : 1 }}>
